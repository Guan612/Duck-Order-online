  ...
  return (
    <div className="flex flex-col h-full">
      <div className="h-1/4 flex flex-col">
        <h1 className="text-2xl font-bold mb-4 text-center">菜品管理</h1>
        <div className="flex justify-between items-center mx-2">
          <Button type="primary" className="h-8" onClick={openAddMenuModal}>
            新增菜品
          </Button>
          <Select
            className="w-1/3 h-8"
      ...
      <div className="overflow-y-auto h-3/4">
        {menuList.map((menu: menu) => (
          ...
          >
            ...
            <div className="hidden md:block">{getNemuTypeName(menu.type)}</div>
            <img
            ...
            <Button type="primary" onClick={() => openMenuModal(menu)}>
              编辑菜品
            </Button>
          </div>
        ))}
