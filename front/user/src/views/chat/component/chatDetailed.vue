  ...
  <div class="flex flex-col h-screen">
    ...
    <div class="flex-1 overflow-y-auto p-4">
      <div
        ...
        :key="1"
        class="flex m-2 flex-row items-start"
      >
        <el-avatar src="http://localhost:3000/public/images/jialin.jpg" />
        <div class="m-2 p-2 bg-transblue rounded-lg max-w-80">
          {{ item.message }}
        </div>
      </div>
    </div>
    <div class="flex flex-col bg-blue-300 h-1/6">
      ...
      <div class="flex flex-row items-center justify-center">
        <el-input v-model="msgContext" placeholder="请输入内容"></el-input>
